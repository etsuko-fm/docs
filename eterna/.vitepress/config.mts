...
export default defineConfig({
  ...
  rewrites: {
    ...
    'reference/pages/5_levels.md': 'reference/pages/levels.md',
    'reference/pages/6_panning.md': 'reference/pages/panning.md',
    ...
    'reference/pages/10_hpf.md': 'reference/pages/hpf.md',
    'reference/pages/11_echo.md': 'reference/pages/echo.md',
    'reference/pages/12_master.md': 'reference/pages/master.md',
  },
